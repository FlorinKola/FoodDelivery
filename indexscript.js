...
document.querySelectorAll('.addbtn').forEach(x => { //onclick listener to made the add to cart button increase the amount for any item and increase the total amount
